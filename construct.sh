...
python construct_nl_data.py \
    ...
    --output_path /Users/lavander/cpan/h411711/cf/natural_language_dataset.csv \
    --n 1000

python construct_nl_data.py \
    --input_path /Users/lavander/cpan/h411711/RippleNet-PyTorch-baseline/src/results/top_k_recommendations.csv \
    --output_path /Users/lavander/cpan/h411711/RippleNet-PyTorch-baseline/src/results/natural_language_dataset.csv \
    --n 1000    
...
def translate(edge, n, args):
    Q = ''
    Q= Q+'Answer should end with one of the following sentences: (1) yes, there is a cycle in this graph.  (2)  no, there is no cycle in this graph.\n'
    ...
    for i in tqdm(range((g_num + batch_num - 1) // batch_num)):
        ...
        for j in range(len(Q_list)):
            ...
            for k in range(sc):
                ...
                if pos == -1:
                    pos = 0
                p1 = ans.find("no, there is no cycle")  # for codex
                p2 = ans.find("yes, there is a cycle")  # for codex
